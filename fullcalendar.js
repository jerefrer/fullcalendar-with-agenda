...
function Calendar(element, options, eventSources) {
  ...
  function initialRender() {
    ...
    $("<div class='fc-content-paul' style='position:relative;'/></div>").appendTo(element); // added by Paul Wolbers 5-5-2012
          ...
          if (buttonName == 'title') {
            ...
            if (buttonClick) {
              ...
              var button = $(
                ...
                .click(function() {
                  if (!button.hasClass(tm + '-state-disabled')) {
                    hideAgendaOverviewButton(); // added by Paul Wolbers 5-5-2012
                    buttonClick();
                  }
                })
                .mousedown(function() {
